...
namespace Cloud.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (CloudServer.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return CloudServer.GetDefaultEncoding().GetString(ReadFixedValue());
        }
