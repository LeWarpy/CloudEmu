...
using Cloud.Communication.Packets.Incoming.Quiz;
using Cloud.Communication.Packets.Incoming.Catalog;
using Cloud.Communication.Packets.Incoming.Handshake;
using Cloud.Communication.Packets.Incoming.Navigator;
using Cloud.Communication.Packets.Incoming.Quests;
using Cloud.Communication.Packets.Incoming.Rooms.Avatar;
using Cloud.Communication.Packets.Incoming.Rooms.Chat;
using Cloud.Communication.Packets.Incoming.Rooms.Games;
using Cloud.Communication.Packets.Incoming.Rooms.Connection;
using Cloud.Communication.Packets.Incoming.Rooms.Engine;
using Cloud.Communication.Packets.Incoming.Rooms.Action;
using Cloud.Communication.Packets.Incoming.Users;
using Cloud.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Cloud.Communication.Packets.Incoming.Inventory.Purse;
using Cloud.Communication.Packets.Incoming.Sound;
using Cloud.Communication.Packets.Incoming.Misc;
using Cloud.Communication.Packets.Incoming.Inventory.Badges;
using Cloud.Communication.Packets.Incoming.Avatar;
using Cloud.Communication.Packets.Incoming.Inventory.Achievements;
using Cloud.Communication.Packets.Incoming.Inventory.Bots;
using Cloud.Communication.Packets.Incoming.Inventory.Pets;
using Cloud.Communication.Packets.Incoming.LandingView;
using Cloud.Communication.Packets.Incoming.Messenger;
using Cloud.Communication.Packets.Incoming.Groups;
using Cloud.Communication.Packets.Incoming.Rooms.Settings;
using Cloud.Communication.Packets.Incoming.Rooms.AI.Pets;
using Cloud.Communication.Packets.Incoming.Rooms.AI.Bots;
using Cloud.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Cloud.Communication.Packets.Incoming.Rooms.Furni;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Cloud.Communication.Packets.Incoming.Help;
using Cloud.Communication.Packets.Incoming.Rooms.FloorPlan;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Cloud.Communication.Packets.Incoming.Moderation;
using Cloud.Communication.Packets.Incoming.Inventory.Furni;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Cloud.Communication.Packets.Incoming.Inventory.Trading;
using Cloud.Communication.Packets.Incoming.GameCenter;
using Cloud.Communication.Packets.Incoming.Marketplace;
using Cloud.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Cloud.Communication.Packets.Incoming.Talents;
using Cloud.Communication.Packets.Incoming.QuickPolls;
using Cloud.Communication.Packets.Incoming.Help.Helpers;
using Cloud.Communication.Packets.Incoming.Rooms.Polls;

namespace Cloud.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Cloud.Communication.Packets");
