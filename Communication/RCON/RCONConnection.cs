...
namespace Cloud.Communication.RCON
{
    public class RCONConnection
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Cloud.Communication.RCON.RCONConnection");
        ...
        public void OnCallBack(IAsyncResult iAr)
        {
            try
            {
                ...
                if (!CloudServer.GetRCONSocket().GetCommands().Parse(data))
                {
