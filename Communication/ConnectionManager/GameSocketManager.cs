...
using Cloud.Communication.ConnectionManager.Socket_Exceptions;
using log4net;
...
namespace Cloud.Communication.ConnectionManager
{
	...
	{
		private static readonly ILog log = LogManager.GetLogger("Cloud.Communication.ConnectionManager");
		...
		public void Init(int portID, int maxConnections, int connectionsPerIP, IDataParser parser, bool disableNaglesAlgorithm)
		{
			...
			log.Info("» Configuración satisfactoria de los puetos: (" + portID + ")!");
			log.Info("» Maximas conexiones por IP [" + connectionsPerIP + "]!");
		}
