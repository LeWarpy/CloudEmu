...
namespace Cloud.HabboHotel.Users.Process
{
	sealed class ProcessComponent
	{
		private static readonly ILog log = LogManager.GetLogger("Cloud.HabboHotel.Users.Process.ProcessComponent");
		...
		public void Run(object State)
		{
			try
			{
				...
				if (_player.GetClient() != null)
					CloudServer.GetGame().GetAchievementManager().ProgressAchievement(_player.GetClient(), "ACH_AllTimeHotelPresence", 1);
