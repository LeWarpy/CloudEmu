...
namespace Cloud.HabboHotel.Quests
{
    public class QuestManager
    {
        private static readonly ILog log = LogManager.GetLogger("Cloud.HabboHotel.Quests.QuestManager");
        ...
        public void Init()
        {
            ...
            log.Info("» Quest Manager -> CARGADO");
        }
