...
namespace Cloud.HabboHotel.Rooms.AI
{
    public class Pet
    {
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = CloudServer.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (CloudServer.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((CloudServer.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return CloudServer.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
